...
html_df_location <- formattable(df_location, list(n = color_tile("white", "orange")))
saveWidget(as.htmlwidget(html_df_location), 
           file = "~/Documents/paulant/mapfiction/html/table_location.html", 
           selfcontained = TRUE)
